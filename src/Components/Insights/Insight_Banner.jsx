...
import Allinsights from "./All_insights";
        ...
        fetch("https://resi.build/backend/wp-json/wp/v2/pages/127")
            ...
            .then((data) => {
                ...
                if (data?.acf) {
                    ...
                    setTitle(data?.acf?.banner_section.title || "");
                    setdescription(data?.acf?.banner_section.description || "");
                    setbuttontext(data?.acf?.banner_section.button_text || "");
                    setbuttonlink(data?.acf?.banner_section.button_link || "");
                    setEventtitle(data?.acf?.filter_title || "");
                    setPodtitle(data?.acf?.podcast_section.heading || "");
        ...
        <>
            <div className="banner-area other-pages">
                <video
                    ...
                    poster={banner_bg}
                >
                    <source src="http://baltejb8.sg-host.com/wp-content/uploads/2025/01/Insight-Page.mp4" type="video/mp4" />
                    Your browser does not support the video tag.
                </video>
                <div className="page-banner-area bg-1 ptb-130 events-page-banner">
                    <div className="container">
                        <div className="page-banner-content">
                            ...
                            <p className="custom-text-white w-50">{description}</p>
