        ...
        fetch("https://resi.build/backend/wp-json/wp/v2/pages/54")
            ...
            .then((data) => {
                ...
                if (data?.acf) {
                    ...
                    setTitle(data?.acf?.banner_content.heading || "");
        ...
        <>
            <div className="banner-area other-pages">
                <video
                    ...
                    poster={banner_bg}
                >
                    <source src="https://resi.build/backend/wp-content/uploads/2024/12/Landing-page-resibuild-v3.mp4" type="video/mp4" />
                ...
                <div className="page-banner-area bg-1 ptb-130 about-page-banner">
                    <div className="container">
                        <div className="page-banner-content">
                            ...
                            />
                            <p className="custom-text-white w-50" dangerouslySetInnerHTML={{ __html: description }} />
