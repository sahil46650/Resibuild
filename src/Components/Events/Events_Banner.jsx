        ...
        fetch("https://resi.build/backend/wp-json/wp/v2/pages/121")
            ...
            .then((data) => {
                ...
                if (data?.acf) {
                    ...
                    setTitle(data?.acf?.banner_content.title || "");
                    setdescription(data?.acf?.banner_content.description || "");
                    setbuttontext(data?.acf?.banner_content.button_text || "");
                    setbuttonlink(data?.acf?.banner_content.button_link || "");
        ...
        <>
            <div className="banner-area other-pages">
                <video
                    ...
                    poster={banner_bg}
                >
                    <source src="https://baltejb8.sg-host.com/wp-content/uploads/2025/01/Events-page-resibuild-1.mp4" type="video/mp4" />
