    ...
    useEffect(() => {
        ...
        fetch("https://resi.build/backend/wp-json/wp/v2/pages/123")
            ...
            .then((data) => {
                ...
                if (data?.acf) {
                    setCtaHeading(data?.acf?.cta_section?.heading || "Default Heading");
                    setCtaText(data?.acf?.cta_section?.description || "");
                    setCtaButtonText(data?.acf?.cta_section?.button_text || "Default Button Text");
                    setCtaButtonLink(data?.acf?.cta_section?.button_link || "#");
                } else {
        ...
        <div className="ready-to-talk-area ptb-130">
            <div className="container">
                <div className="ready-to-talk-content wow animate__animated animate__fadeInUp delay-0-2s">
                    <h2 dangerouslySetInnerHTML={{ __html: ctaheading }} />
                    <p className="">
                                    {ctatext}
                                </p>
                    <Link
