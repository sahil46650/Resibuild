...
const FirstSection = () => {
        ...
        fetch("https://resi.build/backend/wp-json/wp/v2/pages/125")
            ...
            .then((data) => {
                if (data?.acf) {
                    ...
                    setDesignCpdSection(data.acf.design_cpd_section || {});
                } else {
    ...
    return (
        <>
            ...
            {/* Design CPD Section */}
            <div className="about-section-pointers ptb-130 ">
                <div className="container">
                    ...
                    {designCpdSection.about_cpd?.map((item, index) => (
                        <div
                            className={`row align-items-center pb-70 ${index % 2 === 0 ? "before-lg-mobile-reverse-row" : ""
                                }`}
                            key={index}
                        >
                            {index % 2 === 0 ? (
